   ...
   """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        #import pdb
        #pdb.set_trace()
        if kwargs["config"].tie_word_embeddings:
            self.model.lm_head_weight = self.model.embed_tokens.weight
        else:
            self.model.lm_head = ParallelLMHead(kwargs["config"].vocab_size, kwargs["config"].hidden_size)
            self.model.lm_head_weight = self.model.lm_head.weight
